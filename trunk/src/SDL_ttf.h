 ...
 */
extern const SDL_version * SDLCALL TTF_Linked_Version(void);
...
*/
extern void SDLCALL TTF_ByteSwappedUNICODE(int swapped);
...
extern TTF_Font * SDLCALL TTF_OpenFontIndex(const char *file, int ptsize, long index);
extern TTF_Font * SDLCALL TTF_OpenFontRW(SDL_RWops *src, int freesrc, int ptsize);
extern TTF_Font * SDLCALL TTF_OpenFontIndexRW(SDL_RWops *src, int freesrc, int ptsize, long index);
...
extern char * SDLCALL TTF_FontFaceFamilyName(const TTF_Font *font);
extern char * SDLCALL TTF_FontFaceStyleName(const TTF_Font *font);

/* Get the metrics (dimensions) of a glyph
   To understand what these metrics mean, here is a useful link:
    http://freetype.sourceforge.net/freetype2/docs/tutorial/step2.html
 */
extern int SDLCALL TTF_GlyphMetrics(TTF_Font *font, Uint16 ch,
				     int *minx, int *maxx,
                                     int *miny, int *maxy, int *advance);

/* Get the dimensions of a rendered string of text */
extern int SDLCALL TTF_SizeText(TTF_Font *font, const char *text, int *w, int *h);
extern int SDLCALL TTF_SizeUTF8(TTF_Font *font, const char *text, int *w, int *h);
extern int SDLCALL TTF_SizeUNICODE(TTF_Font *font, const Uint16 *text, int *w, int *h);
