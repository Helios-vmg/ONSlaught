...
/*
Last edit by Helios on 2008-12-16 01:03:00Z

Changed a couple of lines to normalize the look across platforms. Now ONSlaught
has auto-hinter in all platforms.
This can be disabled by #defineing DISABLE_PORTABLE_AUTOHINTER.
*/
...
//#define DISABLE_PORTABLE_AUTOHINTER
#define USE_AUTOHINTER
...
static FT_Error Load_Glyph( TTF_Font* font, Uint16 ch, c_glyph* cached, int want )
{
	...
	*/
#ifndef DISABLE_PORTABLE_AUTOHINTER
#ifdef USE_AUTOHINTER
